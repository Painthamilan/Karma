...
public class ViewSliderProductActivity extends AppCompatActivity {
    ...
    String productUrl,quantity,availability,type;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_slider_product);
    ...
    private void showDialogForConfirmInstant() {
        ...
        AlertDialog.Builder dialogBuilder=new AlertDialog.Builder(ViewSliderProductActivity.this, R.style.AlertDialogTheme).setCancelable(false);
        View rowView= LayoutInflater.from(ViewSliderProductActivity.this).inflate(R.layout.instant_layout,null);
        ...
        cartPayment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ViewSliderProductActivity.this, "Cart payment is not available", Toast.LENGTH_SHORT).show();
            }
        });
        cashOnDelivery.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(nic)){
                    Toast.makeText(ViewSliderProductActivity.this, "Please enter NIC number", Toast.LENGTH_SHORT).show();
                }else {
                    if (isCart){
                        addtoCart();
                    }else {
    ...
    private void addtoCart() {
        ...
        if (TextUtils.isEmpty(phoneNum) || TextUtils.isEmpty(adress)) {
            Toast.makeText(ViewSliderProductActivity.this, "please give phone number and address!", Toast.LENGTH_SHORT).show();
        } else {
            ...
            cardRef.child(curUserId + randomid).updateChildren(postMap).addOnCompleteListener(new OnCompleteListener() {
                ...
                public void onComplete(@NonNull Task task) {
                    if (task.isSuccessful()) {
                        Toast.makeText(ViewSliderProductActivity.this, "Added", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    private void showDialogForConfirmorder() {
        AlertDialog.Builder dialogBuilder=new AlertDialog.Builder(ViewSliderProductActivity.this, R.style.AlertDialogTheme).setCancelable(false);
        View rowView= LayoutInflater.from(ViewSliderProductActivity.this).inflate(R.layout.buy_all_dialog,null);
        dialogBuilder.setView(rowView);
        AlertDialog dialog = dialogBuilder.create();
        if (dialog.getWindow() != null) {
            dialog.getWindow().setBackgroundDrawable(new ColorDrawable(0));
    ...
    private void orderProduct(String nic) {
        ...
        if (TextUtils.isEmpty(phoneNum) || TextUtils.isEmpty(adress)) {
            ...
            ordersref.child(curUserId + randomid).updateChildren(postMap).addOnCompleteListener(new OnCompleteListener() {
                @Override
                public void onComplete(@NonNull Task task) {
                    Toast.makeText(ViewSliderProductActivity.this, "Ordered successfully, We will verify soon..", Toast.LENGTH_SHORT).show();
    ...
    private void showDialogForNotLoggedId() {
        AlertDialog.Builder dialogBuilder=new AlertDialog.Builder(ViewSliderProductActivity.this, R.style.AlertDialogTheme).setCancelable(false);
        View rowView= LayoutInflater.from(ViewSliderProductActivity.this).inflate(R.layout.general_alert_dialog,null);
        dialogBuilder.setView(rowView);
        AlertDialog dialog = dialogBuilder.create();
        if (dialog.getWindow() != null) {
            dialog.getWindow().setBackgroundDrawable(new ColorDrawable(0));
        ...
        dialogConfirmTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(ViewSliderProductActivity.this,LoginActivity.class);
    ...
    private void intentToUpdateDetails() {
        Intent intent=new Intent(ViewSliderProductActivity.this,BottomBarActivity.class);
                ...
                new FirebaseRecyclerAdapter<Img, AdminViewProductActivity.TopViewHolder>(
                    ...
                    protected void populateViewHolder(AdminViewProductActivity.TopViewHolder postViewHolder, Img model, int position) {
                        ...
                        postViewHolder.cfView.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                postViewHolder.showDialog(model.getImageUrl(), ViewSliderProductActivity.this);
                            }
                        });
